...
<html>
	<head>
		...
		<!--LOAD SCRIPTS-->
		<script src="eurovision.js"></script>
	...
	<body onload="init()">
		<div class="w3-container">
			...
			<!-- MODAL -->
			<dialog data-modal>
				<!--button class="w3-button w3-grey w3-right" data-close-modal>Close Settings</button-->
				...
				<select id="eventSelect" name="eventSelect" onchange='updateSettings(event)'>
					...
					<option value="Semi Final #2" selected>Semi Final #2</option>
		...
		<footer class="w3-container w3-padding-32">
			<br>
			<h3>Your Scores Summary:</h3>
			<div id="scoresTable" class="w3-responsive"><em>Will be filled once you adding scores!</em></div>
		</footer>
	</body>
</html>