...
const randomCharacter = () => {
	...
	outfitEl.innerHTML = 'You are wearing a <em>' + topDescriptor + ' ' + topItem + '</em>, <em>' + btmDescriptor + ' ' + btmItem + '</em> and a <em>' + accItem + '</em>. Your Human Believability Score (HBS): <b>' + hbs + '</b>.';
}
