	...
	'technology':
		{
			...
			'G':['Gateway','Graphics','Global'],
			'H':['Hardware','Hypertext','Home'],
			'I':['Internet','Information','Intranet'],
			'J':['Java','Javascript','Join'],
			'K':['Kilobytes','Kilobits'],
			'L':['Local','Laser','Light'],
			'M':['Malware','Megabyte','Megahertz','Modem'],
			'N':['Network','Net','Namespace'],
			'O':['Online','Operating','Object','Oriented'],
			'P':['Performance','Protocol','Pathway','Processor'],
			'Q':['Queue','Quick','Query'],
